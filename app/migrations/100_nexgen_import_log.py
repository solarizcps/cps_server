# -*- coding: utf-8 -*-
"""
DEPRECATED — FAZ-DEPLOY-MIGRATION-KALICI-DUZELTME-1
Bu dosya version=100 çakışması nedeniyle KULLANILMAZ.
Yeni dosya: 110_nexgen_import_log.py (version=110)
Manifest: nexgen_manifest.py

Migration 100 (orijinal P4F metni, arşiv):
=================================================
...
def run():
    ...
    print("=" * 70)
    print("Migration 100 — nexgen_import_batch + nexgen_import_item_log")
    ...
    # schema_migrations
    try:
        cur.execute("INSERT OR IGNORE INTO schema_migrations(version) VALUES(100)")
        con.commit()
    ...
    print("=" * 70)
    print("Migration 100 tamamlandı\n")
