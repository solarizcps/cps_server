    ...
    try:
        ...
        for hk in ham_kalemler:
            ...
            kalem = {
                ...
                # PATCH 3: faturadan okunan TCMB kuru kalem'e baglanir
                # (izleme + fallback). USD parti'ye TRY navlun yuklenince
                # fatura kuru otomatik kullanilir, manuel kur gerekmez.
                'kur_onerisi': kur,
            }
