...
def get_arac_dashboard_dto(
    ...
    return {
        ...
        'drivers': drivers,
        'daily_tasks': tasks,
        'bekleyen_talepler': [] if canonical else bekleyen,
        'bekleyen_count': 0 if canonical else len(bekleyen),
        'mehmet_v2': canonical,
        'daily_totals': {
            'distance_km': '—' if canonical else total_km_plan,
            'duration_label': '—' if canonical else '3s 10dk',
        },
        'weekly_summary': [] if canonical else _weekly_summary(d),
        'history_rows': [] if canonical else _history_rows(),
        'activities': [
