...
ok('LIVEVIS-01 loading resolves helper', 'liveFetchState' in js and 'LIVE_TIMEOUT_MS' in js)
...
ok('LIVEVIS-03 canli tab reload', "tab === 'canli'" in js and 'loadLiveVehicles(false)' in js)
ok('LIVEVIS-05 failure exits loading', "liveFetchState = 'error'" in js and 'showLiveError' in js)
